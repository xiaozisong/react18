(function (global, factory) {
	...
	const MutaionMask = Placement | Update | ChildDeletion;
	...
	class FiberRootNode {
	    ...
	    current;
	    finishedWork;
	    constructor(container, hostRoorFiber) {
	...
	let nextEffect = null;
	const commitMutaionEffects = (finishedWord) => {
	...
	const commitMutaionEffectsOnFiber = (finishedWork) => {
	...
	function commitRoot(root) {
	    ...
	    const subtreeHasEffect = (finishedWork.subtreeFlags & MutaionMask) !== NoFlags;
